...
if torch.cuda.is_available() and not torch.cuda.get_device_capability()[0] >= 9:
    pytest.skip("Test requires CUDA build on SM90+", allow_module_level=True)
...
from torchao.testing.utils import get_available_devices, skip_if_rocm
