...
from torchao.utils import is_MI300, is_MI350, is_sm_at_least_90, is_XPU, torch_version_at_least

_is_xpu = is_XPU()
_is_cuda_compatible = torch.cuda.is_available() and (is_sm_at_least_90() or is_MI300() or is_MI350())
