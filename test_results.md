...
|3.|Missing xpu kernel: mxfp8_quantize_kernel_3d|torchao|• test_kernels.py::test_cuda_mx_dim1_3d_numerics (all 200 parametrizations)|200|mxfp8_quantize_kernel_3d for the xpu should be implemented in torchao|2.12.0.dev20260406+xpu|d26bbae1c|kgajdamo/xpu-moe-debug|
